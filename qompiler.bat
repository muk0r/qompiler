...
If Not Exist "*"\qbsp.exe GoTo NoTools
If Not Exist "*"\vis.exe GoTo NoTools
If Not Exist "*"\light.exe GoTo NoTools
...
bin\qbsp.exe %_qbsp% %2>>Qompiler.txt
bin\vis.exe %_vis% %2>>Qompiler.txt
bin\light.exe %_light% %2>>Qompiler.txt
