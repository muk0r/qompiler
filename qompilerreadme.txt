	...
	Qompiler is aimed to assist all mappers, novice and advanced, with compiling maps. This is based on "Ultimate Quake Map Patcher" by Mankrip(http://quakedev.dcemulation.org/fragger/downloads/tools/uqmp.rar). Currently its set up to run with Ericw's "tyrutils-ericw" compiling tools. (http://ericwa.github.io/tyrutils-ericw/) In the future will be set to search for as many compilers and their accompanying settings as I can cram into it.
	
	[Instructions]
	
	- Extract "Qompiler.zip" into your "Quake" folder. (or anywhere you like, really)
	- If you dont already have them, download the "tyrutils-eric" compiling tools from the link above.
	...
	- Qompiler will prompt you to input your desired settings for each compiling tool. It will display each setting and a description of its function. These can also be found in "tyrutils-eric/doc"
...
I'd like for Qompiler to acheive the following goals:
	...
	Qompiler, is the work of Mukor(mukor.quake@gmail.com) and was inspired by Mankrips "Ultimate Quake Map Patcher" (http://quakedev.dcemulation.org/fragger/downloads/tools/uqmp.rar). Namely, reVis.bat. 

	Ericw for 'tyrutils-ericw'(http://ericwa.github.io/tyrutils-ericw/) as the descriptions are from the "docs" folder for the compiler settings.
